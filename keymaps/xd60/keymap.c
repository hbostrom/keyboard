...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_all( /* CMD60 - QWERTY */
      ...
      KC_LCTL, MO(1),  KC_LALT,                           KC_SPC,                         KC_RALT,  KC_RCTL, MO(1),    MO(1),    KC_NO \
  ),
  LAYOUT_all( /* CMD60 - Arrows */
      ...
      KC_NO,   KC_NO,  KC_NO,    KC_NO,   KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_HOME,KC_PGDN,KC_PGUP,KC_END,     KC_NO,   KC_NO,    KC_NO, \
